...
import { Clock, RotateCcw, Save, Scissors, Tag } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <header className="flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">
            Altere valores e durações a qualquer momento. O site público reflete na hora.
          </p>
        </div>
      ...
      {/*
        ...
        service, so the barber must know a change moves past figures too.
      */}
      <p className="text-xs text-slate-500 bg-[#1a1a1a] border border-gray-800 rounded-lg p-3">
        Atenção: o valor exibido em agendamentos já realizados também acompanha o preço atual do
        serviço.
      </p>
